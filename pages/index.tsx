...
const Home = ({
  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <span
        className={`${styles.spline34} absolute z-0 left-64 md:left-[calc(65%)]`}
      >
        <Image
          src="/splines-00034.png"
          width={1341}
          height={1363}
          alt="spline"
          priority
        ...
        <div className="max-w-screen-xl mx-auto px-9">
          <section className="mb-24 relative">
            <Typography.H2 className="mt-6" as="h1">
              We build tools that <br className="hidden md:block" />
          ...
          <section className="text-center my-20 md:my-36">
            <div>
              <Typography.H2>
                ...
                <GradientText
                  webProperty="story"
                  text=" launch your own marketplace"
                />
              </Typography.H2>
            </div>
...
const articleLimit = 3; //we only show the first 3 so don't ship the rest to the client
